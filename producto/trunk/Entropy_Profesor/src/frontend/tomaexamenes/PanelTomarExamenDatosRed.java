 ...
 * @author Denise
 */
public class PanelTomarExamenDatosRed extends javax.swing.JPanel implements RedAdHocCreator {
     ...
     */
    public PanelTomarExamenDatosRed(PanelTomaExamen padre) {
        this.padre = padre;
    ...
    private void initComponents() {
                ...
                .addGroup(pnlDatosNuevaRedLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(pnlDatosNuevaRedLayout.createSequentialGroup()
                        ...
                        .addGroup(pnlDatosNuevaRedLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtContraseña2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE))))
                .addContainerGap())
        );
        ...
        pnlRedExistenteLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnlRedExistenteLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(rbnRedExistente, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        pnlDatosDeRedLayout.setHorizontalGroup(
            ...
            .addGroup(pnlDatosDeRedLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblIpRed, javax.swing.GroupLayout.DEFAULT_SIZE, 275, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void lblAnteriorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAnteriorMouseClicked
        padre.getPanelDeslizante().setPanelMostrado(padre.getPanelDatosExtras());
        padre.getVentanaPrincipal().setTitle(padre.getVentanaPrincipal().getTitle().replaceFirst("Paso 2", "Paso 1"));
        padre.mostrarBotonPublicar(false);
    ...
    private void lblAnteriorMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAnteriorMouseEntered
        padre.getGestorEstados().setEstadoInstantaneo("Volver al paso 1: datos del examen...");
    ...
    private void lblAnteriorMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAnteriorMouseExited
        padre.getGestorEstados().volverAEstadoImportante();
