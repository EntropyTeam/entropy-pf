 ...
 * @author Denise
 */
public class DialogInfoAlumno extends javax.swing.JDialog {
     ...
     * @param usuario
     */
    public DialogInfoAlumno(JFrame padre, boolean modal, Alumno alumno) {
        super(padre, modal);
        initComponents();
    ...
    private void cargarDatosUsuario(Alumno alumno) {
        ...
        this.lblEmail.setText(alumno.getStrEmail());
        this.lblLegajo.setText(alumno.getStrLegajo());
        if (alumno.getIntNroDocumento() != -1) {
            lblDocumento.setText(alumno.getStrTipoDocumento() + " " + alumno.getIntNroDocumento());
        }
        this.txaDescripcion.setText(alumno.getStrDescripcion());
        if ((byte[]) alumno.getImgFoto() != null) {
            this.pnlImagenLogo.setImagen(Toolkit.getDefaultToolkit().createImage((byte[]) alumno.getImgFoto()));
            this.lblLogo.setVisible(false);
        }
        this.lblIP.setText(alumno.getStrIP());
        this.lblCodigo.setText(alumno.getStrCodigo());
    }
